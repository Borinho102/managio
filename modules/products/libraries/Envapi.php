...
class Envapi
{
    // Purchase verification is fully server-side (VAL_PROD_POINT) via
    // validatePurchase(); the direct-Envato getPurchaseData/verifyPurchase methods
    // and the hardcoded API token were removed.
