<div class="row">
        ...
        <div class="row">
            <div class="panel panel-custom fees_payment">
                ...
                <div class="panel-body">
                    ...
                    <?php }
                    $company_subs = get_old_result('tbl_saas_gateway_subscriptions', ['type' => 'package', 'company_id' => $company_info->id], false);
                    ?>
    ...
    <div id="subscriptions_history">
        ...
        <div class="col-sm-8 print_width">
            ...
            $module_subscription = $this->saas_model->get_module_subscription($company_info->id);
                                                    ...
                                                    <td class="tw-flex tw-justify-between tw-items-center">
                                                        ...
                                                        if (in_array($module, $package_module)) {
                                                            ...
                                                            <?php } else {
                                                                ...
                                                                <a href="<?= admin_url('delete_module/' . $company_info->id . '/' . $module) ?>"
