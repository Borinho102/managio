...
<?php
if (empty(get_option('saas_payment_setup'))) {
    ?>
    <div class="alert alert-danger">
        <strong>Warning!</strong> Please complete your payment gateway setup before proceeding.
        without payment gateway setup, you can't do subscription option for saas packages.
        here is the link for payment gateway setup <a href="<?= saas_url('settings/payments') ?>">click here</a>
    </div>
<?php } ?>
