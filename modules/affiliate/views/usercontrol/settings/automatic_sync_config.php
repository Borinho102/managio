          	...
          	<div class="col-md-12">
               <div class="form-group" app-field-wrapper="store">
                <label for="store" class="control-label"><?php echo _l('store'); ?></label>
                  <select id="store" name="store" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" data-actions-box="true" tabindex="-98">
                    <option value=""></option>
