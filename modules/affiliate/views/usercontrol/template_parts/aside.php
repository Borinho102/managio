...
<aside id="menu" class="sidebar">
   <ul class="nav metis-menu" id="side-menu">
      <li class="tw-mt-[80px] sm:tw-mt-0 -tw-mx-2 tw-overflow-hidden sm:tw-bg-neutral-900/50">
            <div id="logo" class="tw-py-2 tw-px-2 tw-h-[63px] tw-flex tw-items-center">
                <?php echo get_company_logo('/affiliate/usercontrol', '!tw-mt-0')?>
            </div>
        </li>
      ...
      <li class="menu-item-dashboard">
         <a href="<?php echo site_url('affiliate/usercontrol'); ?>" aria-expanded="false">
          ...
          <?php
         hooks()->do_action('affiliate_before_render_aside_menu');
         ?>
