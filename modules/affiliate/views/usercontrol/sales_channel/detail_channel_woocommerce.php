            ...
            <div class="col-md-12 group_product_id">
               <div class="form-group" app-field-wrapper="group_product_id">
                <label for="group_product_id" class="control-label"><?php echo _l('group_product'); ?></label>
                  <select id="group_product_id" name="group_product_id" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" data-actions-box="true" tabindex="-98" onchange="get_list_product(this); return false;">
                    <option value=""></option>
            ...
            <div class="col-md-12 product_id">
               <div class="form-group" app-field-wrapper="product_id">
                <label for="product_id" class="control-label"><?php echo _l('affiliate_product'); ?></label>
                  <select id="product_id" name="product_id[]" class="selectpicker" multiple  data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" data-actions-box="true" tabindex="-98">
