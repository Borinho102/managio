    ...
    public function view_overview($member_code = '', $id = ''){
        if($this->input->post()){
          ...
          if(is_client_logged_in()){
              ...
              if($data_profile){
                if($data_profile->shipping_street!='' && $data_profile->shipping_city!='' && $data_profile->shipping_state!=''){
                  ...
                  set_alert('warning', _l('please_enter_complete_address_information_before_proceeding_with_your_order'));
