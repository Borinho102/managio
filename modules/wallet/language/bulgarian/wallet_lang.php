...
$lang['wallet_show_debit_stat_card_on_client_portal'] = 'Показване на статистическата карта за дебита на таблото за управление на клиентския портал';
$lang['wallet_show_funding_stat_card_on_client_portal'] = 'Показване на статистическа карта за финансиране на таблото за управление на клиентския портал';
