...
<div class="clearfix"></div>
 <li class="divider period-divider"></li>
<li class="dropdown-submenu pull-left period-filter-wrapper">
    <a href="#" tabindex="-1">Period</a>
    <ul class="dropdown-menu dropdown-menu-left" style="padding:15px; min-width:225px; ">

        <div class="row">
            <div class="col-md-12">
                <label for="report-from" class="control-label">From Date</label>
            ...
            <div class="col-md-12">
                <label for="report-to" class="control-label">To Date</label>
                <div class="input-group date">
