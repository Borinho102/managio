    ...
    public function data_get()
    {
        ...
        $invoices = [
            ...
            'series' => [
                ...
                'data' => [
                    get_invoices_percent_by_status(6)['total_by_status'],
                    get_invoices_percent_by_status(1)['total_by_status'],
                    get_invoices_percent_by_status(3)['total_by_status'],
                    get_invoices_percent_by_status(4)['total_by_status'],
                    get_invoices_percent_by_status(2)['total_by_status'],
                ]
            ]
        ];
