...
class Projects_api_model extends App_Model
{
    ...
    {
        $this->db->select('staff.*, CONCAT(firstname, \' \', lastname) as full_name, staff_id, project_id');
    ...
    public function total_logged_time_by_billing_type($id, $conditions = [])
    {
        ...
        if ($project_data->billing_type == 2) {
            ...
            $data                = $this->projects_api_model->calculate_total_by_project_hourly_rate($seconds, $project_data->project_rate_per_hour);
