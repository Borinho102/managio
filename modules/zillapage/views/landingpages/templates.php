                            ...
                            <div class="col-md-4 itembb">
                                <div class="clearfix blog-bottom blog blogitemlarge">
                                    ...
                                    <div class="content_blog clearfixflex flex-column flex-lg-row">
                                        ...
                                        <div class="_buttons">
                                            <a href="#" class="btn btn-success mright5 mbot10 pull-left display-block btn_builder_template" data-id="<?php echo $item['id']; ?>" data-toggle="modal" data-target="#createModal">
                                            <?php echo _l('builder'); ?></a>
                                            <a href="<?php echo admin_url('zillapage/templates/previewtemplate')."/".$item['id']; ?>" class="btn btn-info mright5 mbot10 pull-left display-block">
                                            <?php echo _l('preview'); ?>
                                            </a>
                                        </div>
                                    </div>
