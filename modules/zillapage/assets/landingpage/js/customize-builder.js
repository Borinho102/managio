(function($) {
    ...
    function renderBlocks(item) {
        ...
        blockManager.add(block_id, {
            label: `<div class='gjs-block-customize' style="pointer-events: all; cursor: move;">
                 <img src="${item['thumb']}" class="block-image" style="pointer-events: none; display: inline-block;" />
                 <div class="my-label-block" style="pointer-events: none;">${item['name']}</div>
               </div>`,
