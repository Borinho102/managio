...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'razorpay/success\/.+', 'pwa/share', 'pwa/files'];
...
if(!isset($config['csrf_exclude_uris'])) { $config['csrf_exclude_uris']=[]; }
$config['csrf_exclude_uris'] = array_merge($config['csrf_exclude_uris'],array('perfex_mobile_companion\/.+'));