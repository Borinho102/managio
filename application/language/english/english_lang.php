...
$lang['email_diagnostics']                                 = 'Email diagnostics';
$lang['email_diagnostics_subheading']                      = 'Send real test emails through every major mail process used by the app.';
$lang['email_diagnostics_info']                            = 'By default each process sends one active template (plus SMTP / simple pipeline). Enable “send all templates” only if you accept many emails in the inbox.';
$lang['email_diag_run_all']                                = 'Run all process tests';
$lang['email_diag_run_one']                                = 'Test';
$lang['email_diag_clear_log']                              = 'Clear log';
$lang['email_diag_results']                                = 'Results';
$lang['email_diag_process']                                = 'Process';
$lang['email_diag_description']                            = 'Description';
$lang['email_diag_send_all_slugs']                         = 'Send all templates in each process (heavier inbox)';
$lang['email_diag_invalid_email']                          = 'Enter a valid email address for diagnostics.';
$lang['email_diag_summary']                                = '%s / %s processes succeeded';
$lang['email_diag_sent_ok']                                = 'Email sent successfully';
$lang['email_diag_send_failed']                            = 'Send failed (template disabled, inactive contact, or SMTP error)';
$lang['email_diag_template_missing']                       = 'Template not found in database';
$lang['email_diag_template_disabled']                      = 'Template is disabled';
$lang['email_diag_no_slugs']                               = 'No templates configured for this process';
$lang['email_diag_unknown_kind']                           = 'Unknown diagnostic kind';
$lang['email_diag_smtp_raw']                               = 'SMTP connection';
$lang['email_diag_smtp_raw_desc']                          = 'Raw SMTP send using current engine/protocol settings';
$lang['email_diag_simple']                                 = 'Simple email pipeline';
$lang['email_diag_simple_desc']                            = 'Emails_model::send_simple_email() used by many modules';
$lang['email_diag_invoice']                                = 'Invoices';
$lang['email_diag_invoice_desc']                           = 'Invoice send, payment recorded, overdue notices';
$lang['email_diag_estimate']                               = 'Estimates';
$lang['email_diag_estimate_desc']                          = 'Estimate send, accept/decline, expiry reminders';
$lang['email_diag_proposal']                               = 'Proposals';
$lang['email_diag_proposal_desc']                          = 'Proposal send, accept/decline, comments';
$lang['email_diag_contract']                               = 'Contracts';
$lang['email_diag_contract_desc']                          = 'Contract send, expiry, signature notifications';
$lang['email_diag_credit_note']                            = 'Credit notes';
$lang['email_diag_credit_note_desc']                       = 'Credit note emails to clients';
$lang['email_diag_subscription']                           = 'Subscriptions';
$lang['email_diag_subscription_desc']                      = 'Subscription send and payment lifecycle emails';
$lang['email_diag_ticket']                                 = 'Support tickets';
$lang['email_diag_ticket_desc']                            = 'Ticket open, reply, assignment, auto-close';
$lang['email_diag_project']                                = 'Projects';
$lang['email_diag_project_desc']                           = 'Project member, discussion and file notifications';
$lang['email_diag_task']                                   = 'Tasks';
$lang['email_diag_task_desc']                              = 'Task assignment, comments, deadlines, status changes';
$lang['email_diag_client']                                 = 'Clients / contacts';
$lang['email_diag_client_desc']                            = 'Client created, statement, password and verification emails';
$lang['email_diag_staff']                                  = 'Staff';
$lang['email_diag_staff_desc']                             = 'Staff created, password, 2FA, reminders, lead assigned';
$lang['email_diag_gdpr']                                   = 'GDPR';
$lang['email_diag_gdpr_desc']                              = 'GDPR removal request notifications';
$lang['smtp_password_decrypt_failed']                      = 'Stored SMTP password cannot be decrypted with the current encryption key. Clear the field, type the password again (Zoho app password if 2FA is on), then Save.';
$lang['smtp_password_unchanged_hint']                      = 'Leave unchanged to keep the current password';
$lang['smtp_zoho_setup_hint']                              = 'Zoho: use smtppro.zoho.com, port 587 + TLS (or 465 + SSL), full email as username, and an <strong>application-specific password</strong> if 2FA is enabled (Accounts → Security → App Passwords). The From/SMTP email must match that Zoho mailbox or alias. See <a href="https://www.zoho.com/mail/help/zoho-smtp.html" target="_blank" rel="noopener">Zoho SMTP help</a>.';
$lang['smtp_test_hint_auth_failed']                        = 'Authentication failed (535). Re-enter the SMTP password and Save. For Zoho/Gmail use an app-specific password, not the web login password. Also confirm username is the full email address.';
$lang['smtp_test_hint_generic']                            = 'Check host, port, encryption, username, and password.';
$lang['smtp_test_hint_connection_failed']                  = 'Could not connect to the SMTP server. Check host, port, and encryption (TLS/SSL).';
$lang['smtp_test_hint_provider_rejected']                  = 'Connected and authenticated, but the provider rejected the message.';
$lang['smtp_test_hint_zoho_blocked']                       = 'Zoho blocked sending due to unusual activity. <a href="https://mail.zoho.com/UnblockMe" target="_blank" rel="noopener">Unblock your Zoho account</a>, then retry.';
$lang['smtp_zeptomail_setup_hint']                         = 'ZeptoMail: host <code>smtp.zeptomail.com</code>, port <code>587</code> + TLS, username must be <code>emailapikey</code>, password = <strong>Send Mail Token</strong> from ZeptoMail → Agent → SMTP/API (not your Zoho Mail login password). From address domain must be verified on that Agent. <a href="https://www.zoho.com/zeptomail/help/smtp-home.html" target="_blank" rel="noopener">ZeptoMail SMTP docs</a>.';
$lang['zeptomail_api_key_label']                           = 'ZeptoMail Send Mail Token (SMTP password)';
$lang['zeptomail_api_key_placeholder']                     = 'Paste Send Mail Token from ZeptoMail Agent';
$lang['zeptomail_api_key_required']                        = 'No ZeptoMail token saved yet. Paste the Send Mail Token, then Save, then send a test email.';
$lang['zeptomail_api_key_decrypt_failed']                  = 'Stored ZeptoMail token cannot be decrypted (or is empty). Clear the field, paste a fresh Send Mail Token from ZeptoMail → Agent → SMTP/API, then Save.';
$lang['smtp_test_hint_zeptomail_auth_failed']              = 'ZeptoMail rejected the credentials (535). Use username <code>emailapikey</code> and the Agent <strong>Send Mail Token</strong> as password (SMTP/API tab). Do not use a Zoho Mail mailbox password. Also check Agent credits are not expired/blocked.';
$lang['saas_tenant_email_inherited_notice']                = 'This tenant SMTP settings are automatically synced from the parent Managio site. Local changes will be overwritten on the next request unless option <code>saas_use_own_email_settings</code> is set to 1.';
