...
function html_purify($content)
{
    ...
    $prevReporting = error_reporting(error_reporting() & ~E_DEPRECATED & ~E_USER_DEPRECATED);
    ...
    try {
        ...
        log_message('error', 'html_purify failed: ' . $e->getMessage());

        return function_exists('e') ? e($content) : htmlspecialchars((string) $content, ENT_QUOTES, 'UTF-8');
    } finally {
